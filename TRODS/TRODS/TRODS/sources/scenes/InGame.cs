...
namespace TRODS
{
    ...
    class InGame : AbstractScene
    {
        ...
        public InGame(Rectangle windowSize, KeyboardState keyboardState, MouseState mouseState)
        {
            ...
            map.Elements.Add(new AbstractMap.Element(new AnimatedSprite(new Rectangle(0, 150, _windowSize.Width / 2, _windowSize.Height - 150), _windowSize, "sprites/fireWall_11x6r23r45", 11, 6, 30, 23, 44, 1, true), 1f, 0.5f));
            map.Elements.Add(new AbstractMap.Element(new AnimatedSprite(new Rectangle(map.Visitable.Last<Rectangle>().Width + (int)map.VuePosition.X - 150, 150, _windowSize.Width / 2 - 20, _windowSize.Height - 150), _windowSize, "sprites/fireWall_11x6r23r45", 11, 6, 30, 23, 45, 1, true), 1f, 0.5f));
